...
<header class="site-header">
            ...
            <div class="header-controls">
                ...
                <button class="profile-widget-btn" id="profileDropdownTrigger" type="button" aria-label="User account profile settings">
                    <div class="avatar" id="avatarIcon">G</div>
                ...
                <div class="profile-dropdown" id="profileDropdown">
                    <div class="dropdown-user-info">
                        <div class="avatar" id="dropdownAvatar">G</div>
                        <div class="dropdown-user-details">
                            <span class="dropdown-name" id="dropdownName">Guest User</span>
                            <span class="dropdown-role" id="dropdownRole">Visitor</span>
                        </div>
                    </div>
                    
                    <div class="account-note">
                        <span>Visitor access</span>
                        <small>Developer and admin workspaces require separate login.</small>
                    </div>
                </div>
            </div>
        </header>
...
<!-- Admin Login Tab Panel -->
            <div class="tab-panel active" id="panel-admin-login">
                ...
                <div class="access-login-grid">
                    ...
                    <form class="access-card" id="adminLoginForm" method="post" action="{{ route('admin.login.submit') }}" data-real-auth="true">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-input" id="adminEmail" name="email" type="email" value="{{ old('email') }}" placeholder="admin@gmail.com" autocomplete="username" required>
                        </div>
                        <div class="form-group">
                            <label for="adminPassword">Password</label>
                            <input class="form-input" id="adminPassword" name="password" type="password" placeholder="admin123" autocomplete="current-password" minlength="6" required>
                        </div>
