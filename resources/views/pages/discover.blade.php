...
<head>
    ...
    <title>Appex - Discover</title>
    @include('components.theme-loader')
    @vite(['resources/css/app.css', 'resources/css/pages/discover.css', 'resources/js/core.js', 'resources/js/marketplace.js'])
</head>
<body
    data-page="discover"
    @auth
...
<header class="site-header">
            ...
            <div class="header-controls">
                <nav class="header-nav" aria-label="Main header navigation">
                    ...
                    <a class="nav-item active" href="{{ route('discover') }}" data-page-link="discover" aria-current="page">
                        <svg viewBox="0 0 24 24">
                            <circle cx="11" cy="11" r="8" stroke-linecap="round" stroke-linejoin="round"/>
                            <line x1="21" y1="21" x2="16.65" y2="16.65" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
...
<!-- Discover Tab Panel -->
            <div class="tab-panel active" id="panel-discover">
                ...
                <div class="discover-controls" style="display: flex; flex-direction: column; gap: 10px;">
                    <div class="category-pills" id="platformPillContainer" role="tablist" aria-label="Filter platform types">
                        <button class="category-pill active" data-platform="" role="tab" aria-selected="true">All Platforms</button>
                        <button class="category-pill" data-platform="web" role="tab" aria-selected="false">Web</button>
                        <button class="category-pill" data-platform="desktop" role="tab" aria-selected="false">Desktop</button>
                        <button class="category-pill" data-platform="ios" role="tab" aria-selected="false">iOS</button>
                        <button class="category-pill" data-platform="mac" role="tab" aria-selected="false">macOS</button>
                        <button class="category-pill" data-platform="android" role="tab" aria-selected="false">Android</button>
                    </div>
                    <div class="category-pills" id="categoryPillContainer" role="tablist" aria-label="Filter category types">
                        <button class="category-pill active" data-category="" role="tab" aria-selected="true">All Categories</button>
                        @foreach ($categories as $category)
                            <button class="category-pill" data-category="{{ $category->slug }}" role="tab" aria-selected="false">{{ $category->name }}</button>
                        @endforeach
                    </div>
                </div>
